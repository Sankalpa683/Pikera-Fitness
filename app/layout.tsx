...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://fitness.pikeraai.com/"),
  alternates: {
    canonical: "/",
  },
  openGraph: {
    title: "Nepali Food Macros | Pikera Fitness",
    description: "Track calories, proteins, carbs and fats in traditional Nepali meals with Pikera Fitness.",
    url: "https://fitness.pikeraai.com/",
    siteName: "Pikera Fitness",
    images: [
      {
        url: "https://fitness.pikeraai.com/nepali-food-macros.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Nepali Food Macros – Pikera Fitness",
    description: "100+ Nepali food macro breakdowns – calories, protein, carbs, and fat – all in one page.",
    site: "@pikera_fitness",
